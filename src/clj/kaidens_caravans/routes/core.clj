...
(defapi my-routes
  ...
  (context "/caravans" []
    ...
    (GET "/type/" {} (caravans/distinct-type-list))
    (GET "/make/" {} (caravans/distinct-make-list))
    (GET "/model/" {} (caravans/distinct-model-list))
    (GET "/condition/" {} (caravans/distinct-condition-list))))
